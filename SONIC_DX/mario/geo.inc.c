...
const GeoLayout mario_right_hand_open_armature[] = {
	GEO_TRANSLATE_ROTATE(1, 30, 0, -12, 0, 0, 0),
	GEO_OPEN_NODE(),
...
const GeoLayout mario_left_hand_open_armature[] = {
	GEO_TRANSLATE_ROTATE(1, 27, 0, 11, 0, 0, 0),
	GEO_OPEN_NODE(),
...
const GeoLayout mario_002_switch_opt0_001_switch_opt1[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ANIMATED_PART(1, -44, 0, 0, NULL),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(5, 112, 0, 0, mario_000_offset_001_mesh),
					GEO_OPEN_NODE(),
						...
						GEO_OPEN_NODE(),
							...
							GEO_CLOSE_NODE(),
						GEO_CLOSE_NODE(),
						GEO_ANIMATED_PART(1, 79, -10, 48, NULL),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(5, 0, 0, 0, mario_000_offset_003_mesh),
							GEO_OPEN_NODE(),
								GEO_ANIMATED_PART(5, 66, 0, 1, mario_000_offset_004_mesh),
								GEO_OPEN_NODE(),
									GEO_SWITCH_CASE(1, geo_switch_mario_hand),
									GEO_OPEN_NODE(),
										GEO_NODE_START(),
										GEO_OPEN_NODE(),
											GEO_ANIMATED_PART(1, 116, 0, -10, NULL),
											GEO_OPEN_NODE(),
							...
							GEO_CLOSE_NODE(),
						GEO_CLOSE_NODE(),
						GEO_ANIMATED_PART(1, 78, -10, -49, NULL),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(5, 0, 0, 0, mario_000_offset_006_mesh),
							GEO_OPEN_NODE(),
								GEO_DISPLAY_LIST(5, mario_000_offset_007_skinned),
								GEO_ANIMATED_PART(5, 68, 0, -1, mario_000_offset_007_mesh),
								GEO_OPEN_NODE(),
									GEO_SWITCH_CASE(0, geo_switch_mario_hand),
									GEO_OPEN_NODE(),
										GEO_NODE_START(),
										GEO_OPEN_NODE(),
											GEO_ANIMATED_PART(1, 110, 0, 11, NULL),
											GEO_OPEN_NODE(),
												...
												GEO_CLOSE_NODE(),
												GEO_HELD_OBJECT(0, -23, 0, -1, geo_switch_mario_hand_grab_pos),
											GEO_CLOSE_NODE(),
										GEO_CLOSE_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_ANIMATED_PART(1, 88, -8, 28, NULL),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(5, 0, 0, 0, mario_000_offset_009_mesh),
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(5, 80, 0, 2, mario_000_offset_010_mesh),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(5, 115, 0, 1, mario_000_offset_011_mesh),
						GEO_CLOSE_NODE(),
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_ANIMATED_PART(1, 88, -8, -29, NULL),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(5, 0, 0, 0, mario_000_offset_012_mesh),
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(5, 79, 0, 0, mario_000_offset_013_mesh),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(1, 114, 0, -10, NULL),
							GEO_OPEN_NODE(),
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_ROTATION_NODE(0, 0, 0, 0),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(1, 112, 0, 0, mario_000_offset_001_mesh_mat_override_metal_0),
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(1, 87, 0, 0, NULL),
						GEO_OPEN_NODE(),
							GEO_ASM(0, geo_mario_head_rotation),
						...
						GEO_OPEN_NODE(),
							...
							GEO_OPEN_NODE(),
								GEO_ANIMATED_PART(1, 66, 0, 1, mario_000_offset_004_mesh_mat_override_metal_0),
								GEO_OPEN_NODE(),
									GEO_SWITCH_CASE(1, geo_switch_mario_hand),
									GEO_OPEN_NODE(),
										GEO_NODE_START(),
						...
						GEO_OPEN_NODE(),
							...
							GEO_OPEN_NODE(),
								GEO_DISPLAY_LIST(1, mario_000_offset_007_skinned_mat_override_metal_0),
								GEO_ANIMATED_PART(1, 68, 0, -1, mario_000_offset_007_mesh_mat_override_metal_0),
								GEO_OPEN_NODE(),
									GEO_SWITCH_CASE(0, geo_switch_mario_hand),
									GEO_OPEN_NODE(),
										GEO_NODE_START(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(1, 80, 0, 2, mario_000_offset_010_mesh_mat_override_metal_0),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(1, 115, 0, 1, mario_000_offset_011_mesh_mat_override_metal_0),
						GEO_CLOSE_NODE(),
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_ANIMATED_PART(1, 88, -8, -29, NULL),
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(1, 79, 0, 0, mario_000_offset_013_mesh_mat_override_metal_0),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(1, 114, 0, -10, NULL),
							GEO_OPEN_NODE(),
								GEO_ASM(2, geo_mario_hand_foot_scaler),
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_ROTATION_NODE(0, 0, 0, 0),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(5, 112, 0, 0, mario_000_offset_001_mesh_mat_override_metal_0),
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(1, 87, 0, 0, NULL),
						GEO_OPEN_NODE(),
							GEO_ASM(0, geo_mario_head_rotation),
						...
						GEO_OPEN_NODE(),
							...
							GEO_OPEN_NODE(),
								GEO_ANIMATED_PART(5, 66, 0, 1, mario_000_offset_004_mesh_mat_override_metal_0),
								GEO_OPEN_NODE(),
									GEO_SWITCH_CASE(1, geo_switch_mario_hand),
									GEO_OPEN_NODE(),
										GEO_NODE_START(),
						...
						GEO_OPEN_NODE(),
							...
							GEO_OPEN_NODE(),
								GEO_DISPLAY_LIST(5, mario_000_offset_007_skinned_mat_override_metal_0),
								GEO_ANIMATED_PART(5, 68, 0, -1, mario_000_offset_007_mesh_mat_override_metal_0),
								GEO_OPEN_NODE(),
									GEO_SWITCH_CASE(0, geo_switch_mario_hand),
									GEO_OPEN_NODE(),
										GEO_NODE_START(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(5, 80, 0, 2, mario_000_offset_010_mesh_mat_override_metal_0),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(5, 115, 0, 1, mario_000_offset_011_mesh_mat_override_metal_0),
						GEO_CLOSE_NODE(),
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_ANIMATED_PART(1, 88, -8, -29, NULL),
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(5, 79, 0, 0, mario_000_offset_013_mesh_mat_override_metal_0),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(1, 114, 0, -10, NULL),
							GEO_OPEN_NODE(),
								GEO_ASM(2, geo_mario_hand_foot_scaler),
							...
							GEO_OPEN_NODE(),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_ROTATION_NODE(0, 0, 0, 0),
										GEO_OPEN_NODE(),
											GEO_ANIMATED_PART(1, 112, 0, 0, mario_000_offset_001_mesh),
											GEO_OPEN_NODE(),
												GEO_ANIMATED_PART(1, 87, 0, 0, NULL),
												GEO_OPEN_NODE(),
													GEO_ASM(0, geo_mario_head_rotation),
												...
												GEO_OPEN_NODE(),
													...
													GEO_OPEN_NODE(),
														GEO_ANIMATED_PART(1, 66, 0, 1, mario_000_offset_004_mesh),
														GEO_OPEN_NODE(),
															GEO_SWITCH_CASE(1, geo_switch_mario_hand),
															GEO_OPEN_NODE(),
																GEO_NODE_START(),
												...
												GEO_OPEN_NODE(),
													...
													GEO_OPEN_NODE(),
														GEO_DISPLAY_LIST(1, mario_000_offset_007_skinned),
														GEO_ANIMATED_PART(1, 68, 0, -1, mario_000_offset_007_mesh),
														GEO_OPEN_NODE(),
															GEO_SWITCH_CASE(0, geo_switch_mario_hand),
															GEO_OPEN_NODE(),
																GEO_NODE_START(),
										...
										GEO_OPEN_NODE(),
											...
											GEO_OPEN_NODE(),
												GEO_ANIMATED_PART(1, 80, 0, 2, mario_000_offset_010_mesh),
												GEO_OPEN_NODE(),
													GEO_ANIMATED_PART(1, 115, 0, 1, mario_000_offset_011_mesh),
												GEO_CLOSE_NODE(),
											GEO_CLOSE_NODE(),
										GEO_CLOSE_NODE(),
										GEO_ANIMATED_PART(1, 88, -8, -29, NULL),
										GEO_OPEN_NODE(),
											...
											GEO_OPEN_NODE(),
												GEO_ANIMATED_PART(1, 79, 0, 0, mario_000_offset_013_mesh),
												GEO_OPEN_NODE(),
													GEO_ANIMATED_PART(1, 114, 0, -10, NULL),
													GEO_OPEN_NODE(),
														GEO_ASM(2, geo_mario_hand_foot_scaler),
